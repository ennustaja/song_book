...
public class SongDbAdapter extends SQLiteOpenHelper{
	...
	public Cursor fetchAllSongs() {
        return mDb.query(DB_TABLE, new String[] {KEY_ROWID, KEY_NUMBER,
                KEY_LYRICS}, null, null, null, null, null);
	}
	...
	public Cursor fetchSongsByNumber(int songNum){
    	...
    	try{
    		...
    		result = mDb.query(DB_TABLE, new String[] {KEY_ROWID, KEY_TYPE, KEY_NUMBER, KEY_LYRICS, KEY_INFO},
	    			KEY_NUMBER + "=" + songNum, null, null, null, null);
    	} catch (SQLiteException e){
	...
	public Cursor fetchSongsByString(String str){
    	Cursor result;
    	try{
    		result = mDb.query(DB_TABLE, new String[] {KEY_ROWID, KEY_TYPE, KEY_NUMBER, KEY_LYRICS, KEY_INFO},
	    			KEY_LYRICS + " LIKE '%" + str + "%'" + 
	    			"OR " + KEY_INFO + " LIKE '%" + str + "%'", null, null, null, null);
    	} catch (SQLiteException e){
    		Log.d(TAG, e.toString());
    		result = null;
    	}
